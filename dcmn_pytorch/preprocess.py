from dcmn_pytorch.utils import parse_mc, select_field
import logging
import os
import torch
...
def get_dataloader(data_dir, data_file, num_choices, tokenizer, max_seq_length, batch_size):
    examples = read_swag_examples(os.path.join(data_dir, data_file), is_training=True,
                                        max_pad_length=num_choices + 2)
